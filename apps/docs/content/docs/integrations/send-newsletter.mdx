...
| `recipientEmails` | `string[]` | No* | Email addresses to send to. **Must belong to actual subscribers of this project** — see [Recipient scoping](#recipient-scoping) below. Max 5,000 entries per request. |
